...
{
    // Wrapper to allow HttpResponseMessage returned by HttpClient to be returned by HttpTrigger Azure function which requires and IActionResult return value
